...
public final class SWTStyledText {
    ...
    public SWTStyledText(Composite composite, int style) {
        
        this.textWidget = new StyledText(composite, style);
    ...
    public void setTextModel(TextModel textModel) {
        ...
        textWidget.setContent(new StyledTextContent() {
            ...
            public int getLineAtOffset(int offset) {
            	...
            	// Fix for StyledText asking for offset at 'length' when
            	// at end of buffer
            	
            	final int length = getCharCount();
            	...
            	if (offset == length) {
            		...
            		line = length == 0
            				? 0
    						: (int)textModel.getLineAtOffset(offset - 1);
            	}
            	else if (offset > length) {
            		throw new IllegalArgumentException();
            	}
            	else {
            		line = (int)textModel.getLineAtOffset(offset);
            	}
