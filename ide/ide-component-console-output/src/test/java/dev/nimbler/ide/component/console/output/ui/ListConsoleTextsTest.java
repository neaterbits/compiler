...
import static dev.nimbler.ide.component.console.output.ui.ConsoleTextTest.makeConsoleText;
...
public class ListConsoleTextsTest {
    ...
    public void testRemoveFirst() {
        ...
        consoleTexts.add(makeConsoleText("123\r\n", 0L,  1L));
        consoleTexts.add(makeConsoleText("456\r\n", 5L,  2L));
    	
        consoleTexts.removeFirst(1);
        
        assertThat(consoleTexts.size()).isEqualTo(1);
        assertThat(consoleTexts.getFirst().text.asString()).isEqualTo("456\r\n");
        assertThat(consoleTexts.getLast().text.asString()).isEqualTo("456\r\n");
    }
}
