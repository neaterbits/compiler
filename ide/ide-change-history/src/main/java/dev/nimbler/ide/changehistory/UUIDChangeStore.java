...
final class UUIDChangeStore implements ChangeStore {
    ...
    public void iterateChanges(boolean chronological, ChangeStoreIterator iterator) throws IOException {
        ...
        final ArrayList<UUIDHistoricChangeRefImpl> changeRefs = new ArrayList<>();
        ...
        readChangeFile(getChangeFile(), (line, parts) -> {
            ...
            final UUIDHistoricChangeRefImpl changeRef = new UUIDHistoricChangeRefImpl(
    ...
    private static boolean callIterator(ChangeStoreIterator iterator, UUIDHistoricChangeRefImpl ref) {
        
        final boolean done;
        
        switch (iterator.onChange(ref, ref.getHistoricChangeRef())) {
        case CONTINUE:
            done = false;
            break;
