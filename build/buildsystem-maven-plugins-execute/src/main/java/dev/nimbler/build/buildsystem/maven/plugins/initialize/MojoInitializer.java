...
import dev.nimbler.build.buildsystem.maven.plugins.convertmodel.ConvertModel;
...
public class MojoInitializer {
    ...
    public void initializeMojo(
            ...
            Collection<dev.nimbler.build.buildsystem.maven.project.model.MavenProject> allModules,
            dev.nimbler.build.buildsystem.maven.project.model.MavenProject module,
