package dev.nimbler.build.buildsystem.maven.plugins.convertmodel;
...
import dev.nimbler.build.buildsystem.maven.project.model.MavenBaseBuild;
...
import dev.nimbler.build.buildsystem.maven.project.model.MavenFiles;
...
public class ConvertModel {
    ...
    public static MavenProject convertProject(dev.nimbler.build.buildsystem.maven.project.model.MavenProject mavenProject) {
    ...
    private static Model convertModel(dev.nimbler.build.buildsystem.maven.project.model.MavenProject project) {
