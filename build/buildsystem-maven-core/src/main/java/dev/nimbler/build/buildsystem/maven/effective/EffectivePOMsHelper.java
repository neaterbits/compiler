...
import dev.nimbler.build.buildsystem.maven.MavenConstants;
...
import dev.nimbler.build.buildsystem.maven.effective.POMMerger.MergeFilter;
import dev.nimbler.build.buildsystem.maven.effective.POMMerger.MergeMode;
...
import dev.nimbler.build.buildsystem.maven.variables.MavenBuiltinVariables;
import dev.nimbler.build.buildsystem.maven.variables.VariableExpansion;
