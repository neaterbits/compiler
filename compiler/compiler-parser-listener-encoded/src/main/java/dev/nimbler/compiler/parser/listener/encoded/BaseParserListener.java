...
import dev.nimbler.compiler.ast.encoded.ASTBufferImpl;
import dev.nimbler.compiler.ast.encoded.ASTBufferRead;
import dev.nimbler.compiler.ast.encoded.StringASTBuffer;
...
abstract class BaseParserListener<COMPILATION_UNIT> implements ParseTreeListener<COMPILATION_UNIT> {
    ...
    public final void onTransientFieldModifier(int leafContext) {
        ...
        AST.encodeTransientFieldModifier(astBuffer);
    }
    ...
    public final void onVolatileFieldModifier(int leafContext) {
        ...
        AST.encodeVolatileFieldModifier(astBuffer);
    }
