...
import dev.nimbler.compiler.util.ContextNamePart;
...
import static dev.nimbler.compiler.antlr4.AntlrStringRefs.stringRef;
...
public class Java8AntlrParserListener<COMPILATION_UNIT> extends Java8BaseListener {
	...
	public void enterSuperclass(SuperclassContext ctx) {
		...
		if (Boolean.TRUE) {
    		...
    		for (String part : parts) {
    		    delegate.onClassExtendsNamePart(null, -1L);
    		}
    		*/
		}
	}
	...
	@Override
	public void enterSuperinterfaces(dev.nimbler.compiler.java.Java8Parser.SuperinterfacesContext ctx) {
	...
	public void enterStaticMethodInvocation_lfno_primary(StaticMethodInvocation_lfno_primaryContext ctx) {
		delegate.onMethodInvocationStart(
				context(ctx),
				null, // MethodInvocationType.NAMED_CLASS_STATIC_OR_STATIC_VAR,
	...
	public void enterThrowStatement(ThrowStatementContext ctx) {
		delegate.onThrowStatementStart(context(ctx), stringRef(ctx.keyword), context(ctx.keyword));
	}
