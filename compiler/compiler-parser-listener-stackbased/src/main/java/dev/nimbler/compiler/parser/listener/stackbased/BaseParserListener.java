...
import dev.nimbler.compiler.parser.listener.stackbased.state.BaseStackTryCatchFinally;
import dev.nimbler.compiler.parser.listener.stackbased.state.BaseStackVariableDeclarationList;
import dev.nimbler.compiler.parser.listener.stackbased.state.CallStackEntry;
import dev.nimbler.compiler.parser.listener.stackbased.state.CallableStackEntry;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackAnnotation;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackAnnotationElement;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackAnonymousClass;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackArrayAccess;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackArrayCreationExpression;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackAssignmentExpression;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackAssignmentLHS;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackAssignmentStatement;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackCastExpression;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackCatchBlock;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackClass;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackClassInstanceCreationExpression;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackClassMethod;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackCompilationUnit;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackConditionalExpression;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackConstructor;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackConstructorInvocation;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackDoWhileStatement;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackEnum;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackEnumConstant;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackExpressionList;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackExpressionStatement;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackFieldDeclarationList;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackFinallyBlock;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackForInit;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackForStatement;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackForUpdate;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackGenericParameter;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackGenericTypeArgumentList;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackGenericTypeParameters;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackImplements;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackImport;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackInitializerVariableDeclarationElement;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackInterface;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackInterfaceMethod;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackIteratorForStatement;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackLambdaExpression;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackLambdaFormalParameters;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackNamedClass;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackNamespace;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackNonScopedTypeReference;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackParameter;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackParameterList;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackParameterSignature;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackPrimaryList;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackReferenceTypeArgument;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackResource;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackResourceList;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackReturnType;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackScopedName;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackScopedTypeReference;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackStaticInitializer;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackThrowStatement;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackTryBlock;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackTryCatchFinallyStatement;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackTryWithResourcesStatement;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackTypeBound;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackTypeDefinition;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackTypeReference;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackTypeReferenceList;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackTypeReferenceSetter;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackUnresolvedMethodInvocation;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackVariableDeclaration;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackVariableDeclarationList;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackWhileStatement;
import dev.nimbler.compiler.parser.listener.stackbased.state.StackWildcardTypeArgument;
import dev.nimbler.compiler.parser.listener.stackbased.state.VariableNameSetter;
import dev.nimbler.compiler.parser.listener.stackbased.state.base.ListStack;
