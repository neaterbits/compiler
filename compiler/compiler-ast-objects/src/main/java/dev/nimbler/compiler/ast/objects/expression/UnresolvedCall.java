...
public abstract class UnresolvedCall<N extends CallableName> extends UnresolvedPrimary {

    private final ASTSingle<N> callable;
    private final ASTSingle<ParameterList> parameters;

    protected UnresolvedCall(Context context, N callable, ParameterList parameters) {
        super(context);
