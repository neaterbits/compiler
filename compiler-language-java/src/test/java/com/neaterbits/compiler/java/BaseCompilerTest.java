...
import com.neaterbits.compiler.language.java.JavaCompilerLanguage;
...
public abstract class BaseCompilerTest {
	...
	protected final CompiledAndMappedFiles compileAndMap(FileSpec fileSpec, String text, ResolvedTypes resolvedTypes) throws IOException, ParserException {
	...
	protected static CodeMapCompiledAndMappedFiles<CompilationUnit> compile(
	    ...
	    final Parser<CompilationUnit> parser
	        = new JavaLexerObjectParser();
		
		final JavaCompilerLanguage compilerLanguage = new JavaCompilerLanguage(parser);
