...
public class CrossReferenceTest extends BaseCompilerTest {
	...
	@Test
	public void testLocalVariableNameReference() throws IOException {
		final String source =
	...
	@Test
	public void testLocalVariableNameAssignmentReference() throws IOException {
		final String source =
	...
	@Test
	public void testLocalVariablePrimaryListNameReference() throws IOException {
